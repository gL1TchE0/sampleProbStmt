...
// end::decl[]
    ...
    // tag::load_buffer[]
        ...
        xml_parse_result result = doc.load_buffer(source, size);
    // end::load_buffer[]
    ...
    // tag::load_buffer_inplace_begin[]
        ...
        xml_parse_result result = doc.load_buffer_inplace(buffer, size);
    ...
    // tag::load_buffer_inplace_own[]
        ...
        xml_parse_result result = doc.load_buffer_inplace_own(buffer, size);
    ...
    // tag::load_string[]
        ...
        xml_parse_result result = doc.load_string("<mesh name='sphere'><bounds>0 0 1 1</bounds></mesh>");
    // end::load_string[]
